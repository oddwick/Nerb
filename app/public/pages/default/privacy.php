...
<div class="row">
	<div class="large-12 medium-12 columns">
<p>Privacy Policy for <?= SITE_ADDRESS; ?> (this website).  If you require any more information or have any questions about our privacy policy, please feel free to contact us by email at admin@stampalbumpro.com. </p>
<p>At this website, the privacy of our visitors is of extreme importance to us. This privacy policy document outlines the types of personal information is received and collected by this website and how it is used. </p>
<h4>Log Files</h4>
<p>Like many other Web sites, this website makes use of log files. The information inside the log files includes internet protocol ( IP ) addresses, type of browser, Internet Service Provider ( ISP ), date/time stamp, referring/exit pages, and number of clicks to analyze trends, administer the site, track user&rsquo;s movement around the site, and gather demographic information. IP addresses,
and other such information are not linked to any information that is personally identifiable.</p>
</h4>
...
<p>.:: Google, as a third party vendor, uses cookies to serve ads on this website. </p>
<p>.:: Google's use of the DART cookie enables it to serve ads to users based on their visit to this website and other sites on the Internet. </p>
