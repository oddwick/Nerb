...
class Node
{
     ...
     * @return Controller
     */
    public static function controller(string $path_to_controller, string $mode, int $node, int $offset = 0 ) : Controller
    {
        // load required controller class for the router
        ClassManager::loadclass('Controller');
        ...
        // returns a new controller
        $controller = ClassManager::namespaceWrap( $controller );
    ...
    protected static function getController() : string
    {
        ...
        return ucfirst( array_shift($path) ).'Controller';
    ...
    private static function loadController( string $path_to_controller, string $controller ) : string
    {
        ...
        // this means you blew it and got a big fat error
                ...
                throw new _Error( 'Controller: <code>['.$controller.'Controller]</code> could not be loaded. <br> Hint: try changing DEFAULT_REDIRECT' );	
        }
