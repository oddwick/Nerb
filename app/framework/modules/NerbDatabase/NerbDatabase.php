...
// add database directory to common path for quick file loading
    ...
    */
    protected function __connect()
    {
        ...
        if (! $this->database = new NerbSqli(
            ...
            throw new NerbError("Could not connect to Database host <strong>".$this->params["connection"]["host"]."</strong>. ".mysql_error());
        }
